...
<body>
   ...
   <h2>Current Project</h2>
		<%-- <ul class="list-group">
  			<li class="list-group-item"><label>Project Name:</label><span>${projectInfo.name }</span></li>
  			<li class="list-group-item"><label>Sponsor:</label><span>${projectInfo.sponsor }</span></li>
  			<li class="list-group-item"><label>Description:</label><br/><span>${projectInfo.description }</span></li>
		</ul> --%>
		<ul class="list-group">
